    ...
    <div>
      ...
      <div className='w-full flex md:flex-row flex-col mt-10 gap-[30px]'>
        <div className='flex-1 flex-col'>
          ...
          <div className='relative w-full h-[5px] bg-[#303043] mt-2'>
        ...
        <div className='flex md:w-[100px] w-full flex-wrap justify-between gap-[30px]'>
      ...
      <div className='mt-[60px] flex lg:flex-row flex-col gap-5'>
        <div className='flex-[2] flex flex-col gap-[40px]'>
          <div>
            ...
            <div className='flex flex-row items-center gap-[14px] mt-[20px] flex-wrap'>
